export const GLOBAL_STRINGS = {
  ...
  ignoreStartCommandForParentIssueComment: "Please select a child issue from the specification checklist to work on. The `/start` command is disabled on parent issues.",
