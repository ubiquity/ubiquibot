...
var privateKey = fs.readFileSync(path.join(__dirname, "fixtures/mock-cert.pem"), "utf-8");
describe("My Probot app", function () {
    ...
    test("creates a comment when an issue is opened", function () { return __awaiter(void 0, void 0, void 0, function () {
        var mock;
